...
impl AvmVerify {
    pub fn new(proof: Vec<Vec<u8>>, public_inputs: Vec<u8>) -> Self {
        Self {
            type_name: "AvmVerify".to_string(),
            proof,
            public_inputs,
        }
    }
...
impl AvmCheckCircuit {
    pub fn new(inputs: Vec<u8>) -> Self {
        Self {
            type_name: "AvmCheckCircuit".to_string(),
            inputs,
        }
    }
}
...
pub struct ChonkComputeVk {
    ...
    pub type_name: String,
    pub circuit: CircuitInputNoVK,
    pub use_zk_flavor: bool,
}

impl ChonkComputeVk {
    pub fn new(circuit: CircuitInputNoVK, use_zk_flavor: bool) -> Self {
        Self {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ChonkVerifyFromFields {
    #[serde(rename = "__typename", skip_serializing)]
    pub type_name: String,
    #[serde(with = "serde_vec_bytes")]
    pub proof: Vec<Vec<u8>>,
...
impl ChonkVerifyFromFields {
    pub fn new(proof: Vec<Vec<u8>>, vk: Vec<u8>) -> Self {
        Self {
            type_name: "ChonkVerifyFromFields".to_string(),
            proof,
            vk,
        }
    }
...
impl ChonkCheckPrecomputedVk {
    pub fn new(circuit: CircuitInput, use_zk_flavor: bool) -> Self {
        Self {
...
pub struct SchnorrConstructSignature {
    ...
    pub type_name: String,
    #[serde(with = "serde_bytes")]
    pub message_field: Vec<u8>,
    #[serde(with = "serde_bytes")]
    pub private_key: Vec<u8>,
}

impl SchnorrConstructSignature {
    pub fn new(message_field: Vec<u8>, private_key: Vec<u8>) -> Self {
        Self {
...
impl SchnorrVerifySignature {
    pub fn new(message_field: Vec<u8>, public_key: GrumpkinPoint, s: Vec<u8>, e: Vec<u8>) -> Self {
        Self {
...
/// AvmProveResponse
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct AvmProveResponse {
    #[serde(with = "serde_vec_bytes")]
    pub proof: Vec<Vec<u8>>,
    pub stats: Vec<AvmStat>,
}

/// AvmVerifyResponse
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct AvmVerifyResponse {
    pub verified: bool,
}

/// AvmCheckCircuitResponse
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct AvmCheckCircuitResponse {
    pub passed: bool,
    pub stats: Vec<AvmStat>,
}
...
/// ChonkVerifyFromFieldsResponse
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ChonkVerifyFromFieldsResponse {
    pub valid: bool,
}
...
pub enum Command {
    ...
    AvmProve(AvmProve),
    AvmVerify(AvmVerify),
    AvmCheckCircuit(AvmCheckCircuit),
    ...
    ChonkVerifyFromFields(ChonkVerifyFromFields),
...
impl Serialize for Command {
    ...
    where S: serde::Serializer {
        ...
        match self {
            Command::AvmStat(data) => {
                tuple.serialize_element("AvmStat")?;
            ...
            Command::AvmProve(data) => {
                tuple.serialize_element("AvmProve")?;
                tuple.serialize_element(data)?;
            }
            Command::AvmVerify(data) => {
                tuple.serialize_element("AvmVerify")?;
                tuple.serialize_element(data)?;
            }
            Command::AvmCheckCircuit(data) => {
                tuple.serialize_element("AvmCheckCircuit")?;
                tuple.serialize_element(data)?;
            }
            ...
            Command::ChonkVerifyFromFields(data) => {
                tuple.serialize_element("ChonkVerifyFromFields")?;
                tuple.serialize_element(data)?;
            }
            ...
            where A: SeqAccess<'de> {
                ...
                match name.as_str() {
                    ...
                    "AvmProve" => {
                        let data = seq.next_element()?
                            .ok_or_else(|| serde::de::Error::invalid_length(1, &self))?;
                        Ok(Command::AvmProve(data))
                    }
                    "AvmVerify" => {
                        let data = seq.next_element()?
                            .ok_or_else(|| serde::de::Error::invalid_length(1, &self))?;
                        Ok(Command::AvmVerify(data))
                    }
                    "AvmCheckCircuit" => {
                        let data = seq.next_element()?
                            .ok_or_else(|| serde::de::Error::invalid_length(1, &self))?;
                        Ok(Command::AvmCheckCircuit(data))
                    }
                    "CircuitInput" => {
                        let data = seq.next_element()?
                            .ok_or_else(|| serde::de::Error::invalid_length(1, &self))?;
                    ...
                    "ChonkVerifyFromFields" => {
                        let data = seq.next_element()?
                            .ok_or_else(|| serde::de::Error::invalid_length(1, &self))?;
                        Ok(Command::ChonkVerifyFromFields(data))
                    }
                    "ChonkBatchVerify" => {
                        let data = seq.next_element()?
                            .ok_or_else(|| serde::de::Error::invalid_length(1, &self))?;
...
#[derive(Debug, Clone)]
pub enum Response {
    AvmProveResponse(AvmProveResponse),
    AvmVerifyResponse(AvmVerifyResponse),
    AvmCheckCircuitResponse(AvmCheckCircuitResponse),
    ...
    ChonkVerifyFromFieldsResponse(ChonkVerifyFromFieldsResponse),
...
impl Serialize for Response {
    ...
    where S: serde::Serializer {
        ...
        let mut tuple = serializer.serialize_tuple(2)?;
        match self {
            Response::AvmProveResponse(data) => {
                tuple.serialize_element("AvmProveResponse")?;
                tuple.serialize_element(data)?;
            }
            Response::AvmVerifyResponse(data) => {
                tuple.serialize_element("AvmVerifyResponse")?;
                tuple.serialize_element(data)?;
            }
            Response::AvmCheckCircuitResponse(data) => {
                tuple.serialize_element("AvmCheckCircuitResponse")?;
                tuple.serialize_element(data)?;
            }
            ...
            Response::ChonkVerifyFromFieldsResponse(data) => {
                tuple.serialize_element("ChonkVerifyFromFieldsResponse")?;
                tuple.serialize_element(data)?;
            }
            ...
            where A: SeqAccess<'de> {
                ...
                match name.as_str() {
                    "AvmProveResponse" => {
                        let data = seq.next_element()?
                            .ok_or_else(|| serde::de::Error::invalid_length(1, &self))?;
                        Ok(Response::AvmProveResponse(data))
                    }
                    "AvmVerifyResponse" => {
                        let data = seq.next_element()?
                            .ok_or_else(|| serde::de::Error::invalid_length(1, &self))?;
                        Ok(Response::AvmVerifyResponse(data))
                    }
                    "AvmCheckCircuitResponse" => {
                        let data = seq.next_element()?
                            .ok_or_else(|| serde::de::Error::invalid_length(1, &self))?;
                        Ok(Response::AvmCheckCircuitResponse(data))
                    }
                    "CircuitProveResponse" => {
                        let data = seq.next_element()?
                            .ok_or_else(|| serde::de::Error::invalid_length(1, &self))?;
                    ...
                    "ChonkVerifyFromFieldsResponse" => {
                        let data = seq.next_element()?
                            .ok_or_else(|| serde::de::Error::invalid_length(1, &self))?;
                        Ok(Response::ChonkVerifyFromFieldsResponse(data))
                    }
                    "ChonkBatchVerifyResponse" => {
                        let data = seq.next_element()?
                            .ok_or_else(|| serde::de::Error::invalid_length(1, &self))?;
